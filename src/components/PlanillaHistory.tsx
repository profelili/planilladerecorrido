          ...
          <div className="flex flex-col sm:flex-row gap-3 items-end">
            <div className="flex-1 w-full flex flex-col gap-1.5">
              ...
              <input
                ...
                required
                className="w-full text-xs font-semibold px-3 py-2 bg-slate-50 border border-slate-200 focus:border-indigo-500 focus:bg-white rounded-xl placeholder:text-slate-400 transition-all outline-none"
              />
            </div>
            
            <button
              type="submit"
              className="w-full sm:w-auto px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 active:scale-95 text-white font-bold text-xs rounded-xl shadow-xs transition-all flex items-center justify-center gap-2 cursor-pointer shrink-0"
            >
              <Save className="w-4 h-4" />
              Guardar Copia
            </button>
          ...
          {history.length > 0 && (
            <div className="relative w-full md:w-80">
              <input
                ...
                className="w-full pl-9 pr-3 py-1.5 text-xs font-semibold bg-white border border-slate-200 focus:border-indigo-500 rounded-xl placeholder:text-slate-400 opacity-90 hover:opacity-100 transition-all outline-none"
              />
        ...
        {history.length === 0 ? (
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-8 flex flex-col items-center text-center gap-3">
            ...
            <button 
              ...
              className="text-[11px] font-bold text-indigo-600 hover:underline hover:text-indigo-700 cursor-pointer"
            >
              Limpiar búsqueda
            </button>
          </div>
              ...
              return (
                <div 
                  ...
                  className={`bg-white rounded-2xl border transition-all duration-300 p-4 md:p-5 flex flex-col justify-between ${
                    isExpanded 
                      ? "border-indigo-400 ring-2 ring-indigo-50/50 shadow-md md:col-span-2 lg:col-span-3 bg-indigo-50/5" 
                      : "border-slate-200 hover:border-indigo-200 hover:shadow-xs bg-white"
                  }`}
                >
                  <div className="w-full">
                    ...
                    <div className="flex justify-between items-start gap-2 mb-3">
                      <div className="flex flex-col gap-1 max-w-[75%]">
                        <span className="text-[9px] font-bold text-indigo-600 tracking-wider uppercase">REGISTRO GUARDADO</span>
                        <h3 className="text-xs font-bold text-slate-900 leading-snug" title={entry.title}>
                          {entry.title}
                        </h3>
                      </div>
                      <span className="text-[10px] font-bold bg-indigo-600 text-white px-2 py-0.5 rounded-lg font-mono shrink-0">
                    ...
                    {isExpanded && (
                      <div className="my-4 p-4 bg-slate-50 rounded-xl border border-slate-205 flex flex-col gap-4 animate-in fade-in slide-in-from-top-3 duration-200">
                                ...
                                {entry.data.estudiantes.filter(st => st.nomina?.trim() || st.diagnostico?.trim()).map((st, sidx) => (
                                  <div key={st.id || sidx} className="p-2.5 flex items-center justify-between text-[11px] gap-2 hover:bg-slate-50/50 transition-colors">
                                    ...
                                    <div className="flex items-center gap-1.5 shrink-0 font-medium font-sans text-slate-600 text-[10px]">
                                      ...
                                      {st.incluirDorso ? (
                                        <span className="text-[9px] font-bold bg-indigo-50 text-indigo-800 border border-indigo-200 px-1.5 py-0.5 rounded" title="Aparece en Dorso">DORSO</span>
                                      ) : null}
                                    </div>
                                  </div>
                                ))}
                        ...
                        <div className="text-[10px] font-bold text-indigo-700 bg-indigo-50/80 p-2.5 rounded-lg border border-indigo-100 flex items-center gap-2">
                  ...
                  <div className="flex items-center justify-between mt-3 pt-3 border-t border-slate-100 text-[10px] text-slate-400 font-semibold gap-2">
                    ...
                    <div className="flex items-center gap-1.5 font-sans">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-lg transition-all flex items-center gap-1 cursor-pointer shadow-xs text-[11px]"
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-slate-200 max-w-md w-full overflow-hidden animate-in fade-in zoom-in-95 duration-150">
            <div className="p-5 flex flex-col gap-4">
              <div className="flex items-center gap-3">
                <div className="bg-amber-50 p-2.5 rounded-full text-indigo-600 border border-amber-100">
