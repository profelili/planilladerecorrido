...
export default function PlanillaPreview({ data }: PlanillaPreviewProps) {
  ...
  const padStudents = (studentsList: Student[]): (Student | null)[] => {
  ...
  const frenteStudents = padStudents(data.estudiantes.filter(s => s.incluirFrente));
  const dorsoStudents = padStudents(data.estudiantes.filter(s => s.incluirDorso));
            ...
            <div className="grid grid-cols-12 border-t-2 border-x-2 border-b-2 border-black">
              ...
              <div className="col-span-8 border-r-2 border-black flex flex-col items-center justify-between py-2 px-4 h-[85px]">
                ...
                <div className="text-[10px] w-full flex justify-between items-end font-sans mt-2">
                  ...
                  <span>Maestro/a: <span className="underline decoration-dotted underline-offset-4 font-bold text-slate-800 text-[11px] px-1">{data.docenteNombre || "................................................"}</span></span>
                </div>
              </div>
              ...
              <div className="col-span-2 flex flex-col h-[85px]">
                <div className="grid grid-cols-3 border-b-2 border-black text-center text-[8px] font-bold h-1/2">
                  <div className="border-r border-black flex items-center justify-center flex-col py-1">
                    <span>DÍA</span>
                    <span className="text-[11px] mt-0.5 font-bold h-5 flex items-center">{data.frenteDia || "  "}</span>
                  </div>
                  <div className="border-r border-black flex items-center justify-center flex-col py-1">
                    <span>MES</span>
                    <span className="text-[11px] mt-0.5 font-bold h-5 flex items-center">{data.frenteMes || "  "}</span>
                  </div>
                  <div className="flex items-center justify-center flex-col py-1">
                    <span>AÑO</span>
                    <span className="text-[11px] mt-0.5 font-bold h-5 flex items-center">{data.frenteAnio || "  "}</span>
                  </div>
                </div>
                <div className="flex items-center px-2 justify-start h-1/2 text-[10px] font-bold uppercase font-sans bg-slate-50/50">
                  <span>TURNO: <span className="text-[11px] pl-1 font-bold text-slate-800">{data.turno}</span></span>
                </div>
              </div>
            </div>
            ...
            <table className="w-full text-left border-collapse border-b-2 border-x-2 border-black table-fixed">
              ...
              <tbody>
                {frenteStudents.map((st, idx) => {
                  ...
                  return (
                    <tr key={st.id} className="border-b border-black text-[10px] h-8 align-middle bg-white hover:bg-slate-50 transition-colors">
                      <td className="border-r border-black text-center font-bold">{st.orden || num}</td>
                      <td className="border-r border-black px-1.5 font-sans font-medium text-slate-900 truncate">{st.nomina}</td>
                      <td className="border-r border-black px-1 text-center font-sans">{st.grado}</td>
                      <td className="border-r border-black px-1 text-center font-sans">{st.edad}</td>
                      <td className="border-r border-black px-1 text-center font-sans italic">{st.nac}</td>
                      <td className="border-r border-black px-1.5 font-sans text-[9px] leading-tight truncate" title={st.diagnostico}>{st.diagnostico}</td>
                      <td className="border-r border-black px-1.5 font-sans text-[9px] leading-tight truncate" title={`${st.domicilio} - ${st.telefono}`}>
                      ...
                      <td className="border-r border-black px-1 leading-tight font-sans text-[9px] truncate" title={st.frenteHorario}>{st.frenteHorario}</td>
                      <td className="border-r border-black px-1 text-center font-sans font-semibold">{st.frenteCalif || "-"}</td>
                      <td className="px-1.5 font-sans text-[9px] leading-tight truncate" title={st.frenteObservaciones}>{st.frenteObservaciones}</td>
                    </tr>
                  );
                })}
              </tbody>
          ...
          <div className="border-2 border-black p-4 mt-4 rounded-sm flex flex-col justify-between font-sans">
            ...
            <div className="grid grid-cols-12 gap-y-2 text-[10px] leading-relaxed">
              <div className="col-span-12 flex items-baseline">
                ...
                <span className="border-b border-dashed border-gray-600 px-2 flex-grow font-semibold text-slate-950 ml-1">
              ...
              <div className="col-span-12 flex items-baseline">
                ...
                <span className="border-b border-dashed border-gray-600 px-2 flex-grow font-medium text-slate-800 ml-1 break-all line-clamp-2">
            ...
            <div className="flex justify-end mt-4">
              <div className="text-center w-64 block">
                <div className="border-t border-black w-full pt-1 text-[9px] font-bold uppercase tracking-wider text-slate-600">
                  firma y aclaración
                </div>
              </div>
            </div>
        ...
        >
              ...
              <div className="col-span-10 p-3 flex flex-col justify-between gap-y-1.5 leading-snug">
                <div className="flex justify-between items-center">
                  <span>
                    ...
                    <span className="underline decoration-dotted underline-offset-4 font-bold text-slate-900 px-1 text-[11px]">
                      {data.docenteNombre || "..........................................................................."}
                    </span>
                  </span>
                  <span>
              ...
              <div className="col-span-2 border-l border-black flex flex-col justify-between">
                ...
                <div className="grid grid-cols-3 border-b border-black text-center text-[8px] font-bold h-1/3">
                  <div className="border-r border-black flex items-center justify-center flex-col py-0.5">
                    <span>DÍA</span>
                    <span className="text-[10px] font-bold">{data.dorsoDia || "  "}</span>
                  </div>
                  <div className="border-r border-black flex items-center justify-center flex-col py-0.5">
                    <span>MES</span>
                    <span className="text-[10px] font-bold">{data.dorsoMes || "  "}</span>
                  </div>
                  <div className="flex items-center justify-center flex-col py-0.5">
                    <span>AÑO</span>
                    <span className="text-[10px] font-bold">{data.dorsoAnio || "  "}</span>
                  </div>
                </div>
                {/* Turno */}
                <div className="border-b border-black px-2 flex items-center text-[9px] font-bold h-1/3 bg-slate-50/50">
                  <span>Turno: <span className="text-slate-800 text-[10px] pl-0.5">{data.turno}</span></span>
                </div>
                {/* Mes De */}
                <div className="px-2 flex items-center text-[9px] font-bold h-1/3 bg-slate-50/50">
                  <span>Mes de: <span className="text-slate-800 text-[10px] pl-0.5 italic">{data.dorsoMesDe || "..................."}</span></span>
                </div>
              </div>
            </div>
                ...
                {dorsoStudents.map((st, idx) => {
                  ...
                  return (
                    <tr key={st.id} className="border-b border-black text-[10px] h-8 align-middle bg-white hover:bg-slate-50 transition-colors">
                      <td className="border-r border-black text-center font-bold">{st.orden || num}</td>
                      <td className="border-r border-black px-1.5 font-sans font-medium text-slate-900 truncate">{st.nomina}</td>
                      <td className="border-r border-black px-1.5 font-sans text-[9px] leading-tight truncate" title={st.dorsoDias}>{st.dorsoDias || "-"}</td>
                      <td className="border-r border-black px-1.5 font-sans text-[9px] leading-tight truncate" title={st.dorsoHoras}>{st.dorsoHoras || "-"}</td>
                      <td className="border-r border-black px-1.5 font-sans text-[9px] leading-tight truncate" title={st.domicilio}>{st.domicilio}</td>
                      <td className="border-r border-black px-1.5 font-sans text-[9px] truncate" title={st.telefono}>{st.telefono || "-"}</td>
                      <td className="px-1 text-center font-sans font-semibold text-slate-800">{st.dorsoTotalHoras || "-"}</td>
                    </tr>
                  );
                })}
              </tbody>
          ...
          <div className="border border-black p-3.5 mt-4 rounded-sm flex flex-col justify-between font-sans">
            <div className="text-[10px] leading-relaxed">
              ...
              <div className="text-[8px] text-gray-500 italic mt-2 border-t border-gray-100 pt-2 leading-relaxed max-w-[85%]">
                En Cargo, colocar según corresponda: Maestra/o de Educación Musical / Maestro/a de Educación Plástica / Maestro/a de Educación Artesanal y Técnica / Maestra/o de Grado / Maestra de Atención Temprana / Maestra de Sección.
              </div>
            </div>
